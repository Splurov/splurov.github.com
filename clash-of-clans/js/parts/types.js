...
part('types', function() {
    ...
    var data = {
        ...
        'dark': {
            ...
            'Valkyrie': [480, [0, 70, 100, 130, 160, 190], 8, 3, {1: 1, 7: 1, 8: 2, 9: 4, 10: 5}],
            ...
            'Bowler': [480, [0, 130, 150, 170], 8, 7, {1: 1, 10: 2, 11: 3}]
        },
        'light-spells': {
            ...
            'Rage': [1200, [0, 23000, 25000, 27000, 30000, 33000], 2, 3, {1: 1, 7: 4, 8: 5}],
            'Jump': [1200, [0, 23000, 27000, 31000], 2, 4, {1: 1, 9: 2, 10: 3}],
            'Freeze': [1200, [0, 26000, 29000, 31000, 33000, 35000], 2, 4, {1: 1, 9: 1, 10: 5}]
        },
        'dark-spells': {
            'Poison': [600, [0, 95, 110, 125, 140], 1, 1, {1: 1, 8: 2, 9: 3, 10: 4}],
            'Earthquake': [600, [0, 125, 140, 160, 180], 1, 2, {1: 1, 8: 2, 9: 3, 10: 4}],
            'Haste': [600, [0, 80, 85, 90, 95], 1, 3, {1: 1, 9: 2, 10: 4}]
        }
    };
