...
part('types', function() {
    ...
    var data = {
        'light': {
            'Barbarian': [20, [0, 25, 40, 60, 80, 100, 150, 200], 1, 1, {1: 1, 3: 2, 5: 3, 7: 4, 8: 5, 9: 6, 10: 7}],
            'Archer': [25, [0, 50, 80, 120, 160, 200, 300, 400], 1, 2, {1: 1, 3: 2, 5: 3, 7: 4, 8: 5, 9: 6, 10: 7}],
            ...
            'Balloon': [240, [0, 1000, 1250, 1500, 1750, 2000, 2250], 5, 6, {1: 1, 4: 2, 6: 3, 7: 4, 8: 5, 9: 6}],
        ...
        'dark': {
            ...
            'Hog_Rider': [60, [0, 20, 23, 26, 29, 33], 5, 2, {1: 1, 7: 2, 8: 4, 9: 5}],
