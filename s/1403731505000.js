...
part('types', function() {
    ...
    var data = {
        'light': {
            ...
            'P-E-K-K-A-': [2700, [0, 30000, 35000, 42000, 50000], 25, 10, {1: 1, 8: 3, 10: 4}]
        },
        'dark': {
        ...
        'spells': {
            ...
            'Jump': [2700, [0, 23000, 29000], 1, 4, {1: 1, 9: 2}],
...
part('favorites', [
    ...
    var template = new Hogan.Template({code: function (c,p,i) { var t=this;t.b(i=i||"");t.b("<div class=\"favorite js-favorite\" data-num=\"");t.b(t.v(t.f("index",c,p,0)));t.b("\">");t.b("\n" + i);if(t.s(t.f("types",c,p,1),c,p,0,66,462,"{{ }}")){t.rs(c,p,function(c,p,t){if(t.s(t.f("totalCapacity",c,p,1),c,p,0,85,178,"{{ }}")){t.rs(c,p,function(c,p,t){t.b("<div class=\"favorite__capacity\">");t.b(t.v(t.f("totalCapacity",c,p,0)));t.b("&thinsp;/&thinsp;");t.b(t.v(t.f("maximumCapacity",c,p,0)));t.b("</div>");t.b("\n" + i);});c.pop();}t.b("<table class=\"favorite__objects\">");t.b("\n" + i);if(t.s(t.f("items",c,p,1),c,p,0,241,309,"{{ }}")){t.rs(c,p,function(c,p,t){t.b("<tr>");t.b("\n" + i);t.b("<td class=\"number\">×");t.b(t.v(t.f("quantity",c,p,0)));t.b("</td>");t.b("\n" + i);t.b("<td>");t.b(t.v(t.f("name",c,p,0)));t.b("</td>");t.b("\n" + i);t.b("</tr>");t.b("\n" + i);});c.pop();}t.b("</table>");t.b("\n" + i);t.b("<div class=\"favorite__time\">");t.b(t.t(t.f("time",c,p,0)));t.b("</div>");t.b("\n" + i);t.b("<div class=\"favorite__cost\">");t.b("\n" + i);t.b("<span class=\"icon-");t.b(t.v(t.f("costModifier",c,p,0)));t.b("\">");t.b(t.v(t.f("cost",c,p,0)));t.b("</span>");t.b("\n" + i);t.b("</div>");t.b("\n" + i);});c.pop();}t.b("<button class=\"button js-favorite-load\" data-num=\"");t.b(t.v(t.f("index",c,p,0)));t.b("\">Load</button>");t.b("\n" + i);t.b("<button class=\"button js-favorite-delete\" data-num=\"");t.b(t.v(t.f("index",c,p,0)));t.b("\">Remove</button>");t.b("\n" + i);t.b("</div>");return t.fl(); },partials: {}, subs: {  }});
